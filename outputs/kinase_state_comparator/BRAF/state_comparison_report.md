# BRAF Active/Inactive Structural Comparison
...
- Active: `4e26`, resolution 2.55 A, ligand=1, DFG=in, alphaC=in.
- Inactive: `6v2v`, resolution 2.47 A, ligand=1, DFG=in, alphaC=out.
- Alignment coverage: 0.975; sequence identity: 1.000.
- Compared residues: 269.

## Global comparison

- Global C-alpha RMSD: **2.932 A**.
- Distance-matrix error: **2.055 A**.
...
| --- | --- | --- | --- | --- | --- | --- |
| DFG | 7.000 | 3.556 | 3.061 | 6.035 | 1.453 | 0.990 |
| alphaC | 15.000 | 4.471 | 4.034 | 7.569 | 0.213 | 0.956 |
| activation_loop | 25.000 | 6.842 | 4.655 | 17.217 | 3.309 | 0.839 |
| HRD | 7.000 | 0.949 | 0.923 | 1.199 | 0.126 | 1.000 |
| Lys-Glu | 2.000 | 3.816 | 3.379 | 5.151 | 3.359 | 0.965 |

## Direct answers

- DFG change: 3.556 A local RMSD. This quantifies endpoint displacement, not a verified orientation mechanism.
- alphaC change: 4.471 A local RMSD.
- Activation-loop change: 6.842 A local RMSD.
- Lys-Glu: active=3.276 A, inactive=12.889 A, difference=-9.613 A (NZ-OE side-chain).
